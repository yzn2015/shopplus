...
<div class="box-positon">
    ...
    <form class="ropt">
        <input type="submit" onclick="window.location.href='productList.do';" value="返回列表" class="return-button"/>
    </form>
    <div class="clear"></div>
</div>
...
<div class="body-box" style="float:right">
    <form id="jvForm" action="productAdd.do" method="post" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <c:forEach items="${colors }" var="color">
                        <input type="checkbox" value="${color.id }" name="colorss"/>${color.name }
                    </c:forEach>
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <input type="checkbox" name="sizess" value="S"/>S
                    <input type="checkbox" name="sizess" value="M"/>M
                    <input type="checkbox" name="sizess" value="L"/>L
                    <input type="checkbox" name="sizess" value="XL"/>XL
                    <input type="checkbox" name="sizess" value="XXL"/>XXL
                </td>
            </tr>
            <tr>
                <td width="20%" class="pn-flabel pn-flabel-h">
